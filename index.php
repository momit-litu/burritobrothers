    ...
    <div class="main-part" id="content" style="min-height: 600px;" >
        ...
        <section id="reach-to" class="welcome-part home-icon">
			...
			<div class="build-title">
                ...
                <h2 style="font-size:25px;"> Welcome back to our updated site and Thank You for your patience as we worked on the upgrade.<br/>For existing customers, please follow the link for “Password Reset”
					<div style="padding:20px 5px 20px 5px;">
                        <a href="javascript:void(0)" onclick="active_modal(2)" data-toggle="modal" data-target="#forget_passModal" id="send_password">
                            <img alt="Forget password" style="width: 70px;height: 70px;" src="images/key.png"/>
                        </a>
					</div>
                    Otherwise use the “Register” link to sign up
                    <br/>
                    <div style="padding:20px 5px 20px 5px;">
