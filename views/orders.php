            ...
            <table class="table table-bordered table-hover" id="table_big" style=" background-color: white">
                ...
                <tr>
                    ...
                    foreach($orders_info as $order){
                        ...
                        if(substr( $order['order_no'], 0, 3 ) === "BBG"){
                            $bbg = '';
                        }else{
                        ...
                        if($order['payment_status']==1){
                            $paid="<button class='btn btn-primary btn-sm' onclick='makePayment(".$order_no.",". $order['total_order_amt'].")'>Pay</button>";
                        }else{
                    ...
                    <div class="done_registration ">
                        <div class="doc_content">
                            ...
                            <form class="" method="post" id="non_paypal_form">
                                ...
                                <input type="hidden" name="order_no" id="order_no" value="123456" />
                                <input type="hidden" name="paid_amount" id="paid_amount" value="123456" />
                            </form>
...
<script>
    ...
    $('#make_payment').on('click', function () {
        ...
        if(!$('input[name=payment_method]:checked', '#non_paypal_form').val()){
