    ...
    <div class="main-part" id="content" style="min-height: 600px;" >
                       ...
                       $banner_info =  $dbClass->getResultList("select id,title,text,photo,status from banner_image where status=1  order by id desc limit 3");
                        foreach ($banner_info as $banner){
							...
							echo '<li data-transition="zoomout" data-slotamount="2" data-masterspeed="1000" data-thumb="" data-saveperformance="on" data-title="Slide">
									...
									<!-- LAYERS -->
									<div class="tp-caption very_large_text" data-x="center" data-hoffset="0" data-y="250" data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;" data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;" data-speed="1000" data-start="500" data-easing="Back.easeInOut" data-endspeed="300">'.$home_message_title.'
									</div>
									<!-- LAYERS -->
									<div class="tp-caption medium_text" data-x="center" data-hoffset="0" data-y="340" data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;" data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;" data-speed="1000" data-start="500" data-easing="Back.easeInOut" data-endspeed="300">'.$home_message_details.'
									</div>
									<!-- LAYERS -->
									<div class="tp-caption" data-x="center" data-hoffset="0" data-y="425" data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;" data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;" data-speed="1000" data-start="500" data-easing="Back.easeInOut" data-endspeed="300">
										<a  href="categories.php"  class="button-white">Explore Our Menu</a>
        ...
        <section id="reach-to" class="welcome-part home-icon">
			<div class="row" style="
			  ...
			  <div class="col-xs-6 "><a href="https://www.ubereats.com/washington-dc/food-delivery/burrito-brothers/BHBA8w74Tjy-zeFupL_Zvw" > <img class="thumbnail btn responsive" src="images/yelp.png" style="max-width:100px; padding-left:5px"></a></div>
			...
			<div class="build-title">
                ...
                <h2 style="font-size:25px;"> WelcomeN back to our updated site and Thank You for your patience as we worked on the upgrade.<br/>For existing customers, please follow the link for “Password Reset”
					<div style="padding:20px 5px 20px 5px;">
                        <a href="javascript:void(0)" onclick="active_modal(2)" data-toggle="modal" data-target="#forget_passModal" id="send_password">
                            <img alt="Forgot password" style="width: 70px;height: 70px;" src="images/key.png"/>
                        </a>
					</div>
                    Otherwise use the “Register” link to signn up
                    <br/>
                    <div style="padding:20px 5px 20px 5px;">
                        <a href="javascript:void(0)" onclick="active_modal(3)" data-toggle="modal" data-target="#registerModal" id="send_password">
                            <img alt="Register" style="width: 70px;height: 70px;" src="images/register.png"/>
                        </a>
                    </div>
				</h2>
                <!--Unblock this code and block blew when it will live
				...
				<h2 style="font-size:25px;"> Website is Currently under Maintenance<br/>You May However still order from:<br/>
					<div style="padding:20px 5px 20px 5px;">
						...
						<a href="https://www.doordash.com/store/burrito-brothers-washington-235815/en-US" target="_blank">
							<img alt="Doordash" style="width: 70px;height: 70px;" src="images/doordash.png"/>
						</a>
					</div>
            ...
            <div class="container">
                <div class="build-title">
                    ...
                    <h4 style="font-family:&quot;Pacifico&quot; !important ; color:#319C00 !important; margin-top: 0px  !important;">DC's Tastiest Mexican for  take-out or quick eat in!</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6" style="cursor:pointer">
                            <div class="service-track-inner btn-shadow" id="groupOrder">
                                <div class="service-track-info">
                                    <img src="./images/img36.png" alt="">
                                    <h3>DELIVERY <span>Order</span></h3>
                                    <p>&nbsp;</p>
                                </div>
                        ...
                        if($item["attachment"]!=null){
                            echo('  <div class="item">
                                  <a href="'.$website_url.'admin/document/gallary_attachment/'.$item["attachment"].'" class="magnific-popup">
                                        <img  src="'.$website_url.'admin/document/gallary_attachment/'.$item["attachment"].'" alt="" class="animated captureImage">
