        ...
        <div class="x_content">
            ...
            <div style="height:450px; width:100%; overflow-y:scroll">
                <table id="order_Table" name="table_records" class="table table-bordered  responsive-utilities jambo_table table-striped  table-scroll ">
                    ...
                    <th class="column-title" width="10%">Payment Method</th>
                    <th class="column-title" width="10%">Payment Status</th>
                    <th class="column-title" width="10%">Order Status</th>
        ...
        <div class="modal-dialog" role="document" style="width:80% !important">
            <div class="modal-content">
                <div class="modal-body" >
                    <button id="order_rejected" onclick="update_order_status(2)" type="button" style="min-width: 60px; display: inline-block;" class="btn btn-danger btn-lg">Reject</button>
                            ...
                            <div class="doc_content">
                                <div class="col-md-12" style="margin-left: 0px; padding: 0px; margin-bottom: 20px">
                                    ...
                                    <div class="col-md-6" style="text-align:right">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 print_hide" style="alignment: right">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if($.trim(search_txt) == "Print"){
                        ...
                        //if(ad_delivery_date != '')  serach_areas += "Scheduled Pickup Time: "+ad_delivery_date+" <br>";
                        ...
                        if(!jQuery.isEmptyObject(data.records)){
                            ...
                            html +='<table width="100%" cellpadding="10" border="1px" style="margin-top:10px;border-collapse:collapse"><thead><tr><th style="text-align:center">Order No</th><th style="text-align:center">Customer</th><th style="text-align:center">Product</th><th style="text-align:center">Order Date</th><th style="text-align:center">Scheduled Pickup Time</th><th style="text-align:center">Payment Status</th><th style="text-align:center">Order Status</th></tr></thead><tbody>';
                        ...
                        if(!jQuery.isEmptyObject(records_array)){
                            ...
                            var colums_array=["order_id*identifier*hidden","invoice_no","customer_name","order_date","delivery_date","payment_method","paid_status","order_status","total_order_amt"];
                    ...
                    if(!jQuery.isEmptyObject(data.records)){
                        ...
                        $.each(data.records, function(i,datas){
                            ...
                            if(data.type=='individual') {
                                //alert('indi')
                                if(datas.ASAP==1){
                                    $('#dlv_date').html("<span style='background-color:Lime'>Pickup:<b>ASAP</span></b>");
                                }
                                else {
