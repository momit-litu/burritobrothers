...
<div class="x_panel">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6  col-xs-6 bg-info">
            ...
            <div class="col-lg-3 col-md-3 col-xs-3 bg-success" data-width="">
                <h4 style="text-align:center;min-height:40px" ><b>Sale Amount<br/> &nbsp;</b></h4>
                <hr/>
                <h5 style="text-align:center" id="sell_amount"><!--<b><?php echo number_format($total_payment['total'])!=null? number_format($total_payment['total']) : 0; ?></b>--></h5>
            </div>
			<div class="col-lg-3 col-md-3 col-xs-3 bg-warning" data-width="">
                <h4 style="text-align:center;min-height:40px" ><b>Tips Amount<br/> &nbsp;</b></h4>
                <hr/>
                <h5 style="text-align:center" id="total_tips"></h5>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="x_content">
        ...
        <div style="height:400px; width:100%; overflow-y:scroll">
            <table id="order_Table" name="table_records" class="table table-bordered  responsive-utilities jambo_table table-striped  table-scroll ">
                ...
                <th class="column-title" width="12%">Scheduled Pickup Time</th>
                <th class="column-title" width="10%">Payment Type</th>
				<th class="column-title" width="10%"><span style="color:black">(Customer)</span> Payment Status</th>
                <th class="column-title" width="10%"><span style="color:black">(OurBurrito)</span> Order Status</th>
				<th class="column-title" width="6%">Tips</th>
            ...
            $.ajax({
                ...
                success: function(data) {
                   // console.log(data)
                    ...
                    sell_amount = data.total_payment!=null ? data.total_payment : 0;
                    $("#sell_amount").html("<b>"+ sell_amount +"</b>")
					$("#total_tips").html("<b>"+ total_tips.toFixed(2) +"</b>")
                }
            });
                ...
                success: function(data) {
                    ...
                    if(data.records){
                        ...
                        if(!jQuery.isEmptyObject(records_array)){
                            ...
                            var colums_array=["order_id*identifier*hidden","invoice_no","customer_name","order_date","delivery_date","payment_method","paid_status","order_status","tips","total_order_amt"];
                           ...
                           // console.log(datas)
                            if(data.type=='individual') {
                                ...
                                if(datas.ASAP==1){
                                    ...
                                    $('#dlv_date').html("<span style='background-color:orange'>Scheduled Pickup Time: "+datas.delivery_date+"</span>");
                                }
							...
							$.each(order_arr, function(i,orderInfo){
                                ...
                                if(orderInfo){
									...
									//console.log(order_info_arr.length);
									//alert(order_info_arr[6]);
									//alert(order_info_arr[7])
                                    var total = ((parseFloat(order_info_arr[4])*parseFloat(order_info_arr[5])));
									s_instruction = (order_info_arr.length==8)?order_info_arr[7]:"";
                                    order_tr += '<tr><td class="text-capitalize">'+order_info_arr[2].split('..')[0]+' <br>'+order_info_arr[6].split('..')[0]+' <br><b>Label/Special Instructions: '+s_instruction+'</b></td><td align="center">'+order_info_arr[5]+'</td><td align="right">'+parseFloat(order_info_arr[4]).toFixed(2)+'</td><td align="right">'+parseFloat(total).toFixed(2)+'</td></tr>';
                                    order_total += total;
                                }
                            });
							...
							var total_order_bill = ((parseFloat(order_total)+parseFloat(datas.tax_amount)+parseFloat(datas.tips))-parseFloat(datas.discount_amount));
							var total_paid = parseFloat(datas.total_paid_amount);
							var total_order_amt = parseFloat(datas.total_order_amt);

							
							if(data.type=='individual'){
                                order_tr += '<tr><td colspan="3" align="right" ><b>Total Amount</b></td><td align="right"><b>'+(total_order).toFixed(2)+'</b></td></tr>'+order_summery;
                                if(Math.round(total_order_bill.toFixed(2)) != Math.round(total_paid.toFixed(2))) order_tr += '<tr><td colspan="3" style="color:red" align="right" ><b>Total Amount and paid amount mismatch</b></td><td align="right" style="color:red"  ><b>'+(total_order_bill).toFixed(2)+" - "+(total_paid).toFixed(2)+'</b></td></tr>';
