            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;"> 
                       <a href="" class="website_title" style="font-size:20px !important; font-weight:bold; color: white"><img style="height: 50px; width: auto" src="<?php echo $logo; ?>"> Burrito Brothers</a>
                    </div>
