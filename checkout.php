        ...
        <section class="home-icon shop-cart bg-skeen" style="background-color: rgba(244,242,237,1)">
            ...
            <div class="container">
                                ...
                                <form method="post" name="checkout-form" id="checkout-form">
                                    ...
                                    <div id="take_out" style="display: none">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" name="pickup_date_time" id="pickup_date_time" placeholder="Date and Time" class="input-fields date-picker" required style="border-radius: 10px; width: 215px;">
                ...
                <form class="paypal" method="post" id="paypal_form">
                    ...
                    <input type="hidden" name="first_name" value="<?php echo isset($_SESSION['customer_name'])?$_SESSION['customer_name']:'' ?>" />
